...
@section('content')
    ...
    <section class="relative py-10 bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
        <div
            class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-violet-500/20 to-blue-500/20 rounded-full blur-3xl">
        </div>
        <div
            class="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-violet-500/15 to-blue-500/15 rounded-full blur-3xl">
        </div>
                ...
                <div class="animate-on-scroll space-y-8 text-white">
                    ...
                    <div class="space-y-4">
                        <h1 class="text-4xl md:text-6xl font-display font-bold leading-tight">
                            Building Africa's
                            <span
                                class="bg-gradient-to-r from-violet-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">
                                Digital Future
                            </span>
                        </h1>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 text-center">
                            <div class="text-2xl font-bold text-violet-400 mb-1">100%</div>
                            <div class="text-xs text-gray-400">Bespoke</div>
                        </div>
                        <div class="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 text-center">
                            <div class="text-2xl font-bold text-violet-400 mb-1">AI</div>
                            <div class="text-xs text-gray-400">Enabled</div>
                        </div>
                        <div class="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 text-center">
                            <div class="text-2xl font-bold text-violet-400 mb-1">Africa</div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-2">
                        <a href="https://avectechnologies.com" target="_blank" rel="noopener"
                            class="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-violet-500 to-blue-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    ...
                    <div
                        ...
                        <svg viewBox="0 0 400 440" class="w-full max-w-sm opacity-95" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                ...
                                fill="url(#africaFill)" stroke="#a78bfa" stroke-width="1" stroke-opacity="0.55" />
                            <g stroke="#a78bfa" stroke-width="0.8" stroke-opacity="0.4" stroke-dasharray="4,4">
                            ...
                            <g>
                                <circle cx="275.0" cy="71.0" r="3.5" fill="#a78bfa" />
                                <circle cx="130.8" cy="192.8" r="3.5" fill="#a78bfa" />
                                <circle cx="112.3" cy="197.6" r="3.5" fill="#a78bfa" />
                                <circle cx="303.9" cy="233.2" r="3.5" fill="#a78bfa" />
                                <circle cx="313.8" cy="179.8" r="3.5" fill="#a78bfa" />
                                <circle cx="192.5" cy="248.9" r="3.5" fill="#a78bfa" />
                                <circle cx="258.5" cy="362.2" r="3.5" fill="#a78bfa" />
                                <circle cx="22.9" cy="150.5" r="3.5" fill="#a78bfa" />
                                <circle cx="259.9" cy="306.2" r="6" fill="#60a5fa" />
                            </g>
                            <circle cx="259.9" cy="306.2" r="6" fill="none" stroke="#60a5fa"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16 animate-on-scroll">
                ...
                <h2 class="text-4xl md:text-5xl font-display font-bold text-gray-900 mb-6 leading-tight">
                    The Digital <span
                        class="bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent">Challenge in
                        Africa</span>
                </h2>
    ...
    <section class="py-20 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16 animate-on-scroll">
                ...
                <h2 class="text-4xl md:text-5xl font-display font-bold text-gray-900 mb-6 leading-tight">
                    Three Core <span
                        class="bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent">Pillars</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Core institutional
                            platforms</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Payment systems</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Government digitization
                        </li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Enterprise architecture
                        </li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Secure hosting
                            environments</li>
                    </ul>
                </div>
                ...
                <div
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>ERP systems</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Document management</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Records digitization</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Workflow automation</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>RFID tracking systems</li>
                    </ul>
                </div>
                ...
                <div
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Analytics dashboards</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Intelligence systems</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>Predictive modeling</li>
                        <li class="flex items-start"><span class="text-violet-500 mr-2">•</span>AI-driven decision engines
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
        <div class="absolute inset-0">
            <div
                class="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-violet-500/15 to-blue-500/15 rounded-full blur-3xl">
            </div>
            <div
            ...
            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="text-violet-600 font-medium mb-4">Founder & CEO</div>
                        ...
                        <blockquote
                            class="border-l-4 border-violet-500 pl-4 italic text-gray-700 bg-white rounded-r-lg p-4">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('about') }}"
                                class="text-violet-600 font-semibold hover:text-violet-700 transition-colors duration-300">
    ...
    <section class="py-20 bg-gradient-to-br from-violet-600 via-blue-600 to-blue-600 text-white relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 animate-on-scroll">
            <h2 class="text-4xl md:text-5xl font-display font-bold text-white mb-6 leading-tight">
                Ready to Transform Your <span class="text-cyan-200">Digital Infrastructure?</span>
            </h2>

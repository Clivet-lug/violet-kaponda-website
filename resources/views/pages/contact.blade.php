                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <label class="inquiry-type-option cursor-pointer">
                                        ...
                                        <div
                                            ...
                                            <div class="font-medium text-amber-800 text-sm">General Networking</div>
                                        </div>
                                    </label>
                                </div>
                            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <blockquote class="text-gray-700 mb-4 leading-relaxed">
                        "Exceptional keynote on women's leadership in tech. Violet's authenticity and expertise inspired our
                        entire audience."
                    </blockquote>
                    <div class="flex items-center">
                        <div
                            class="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center text-white font-semibold text-xs mr-3">
                            PM
                        </div>
                        <div>
